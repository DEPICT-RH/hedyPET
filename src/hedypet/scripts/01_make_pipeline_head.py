...
def main(sub,
    ...
    #Resample br38f CT
    ct_ac = next(sub_root.glob("ses-quadra/ct/*rec-ac_ct.nii.gz"))
    ct_out = resample_and_save_bids(ct_ac,target,ct, cval=-1024,order=3,**default_args)
    ...
    #Resample PET
    for pet in sub_root.glob("ses-quadra/pet/*stat*_pet.nii.gz"):
